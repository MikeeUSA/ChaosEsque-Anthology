...
void XonoticVideoSettingsTab_fill(entity me)
{
	...
	me.TR(me);
	me.TR(me);
		me.TD(me, 1, 1, e = makeXonoticTextLabel(0, _("Anaglyph Glasses:")));	
	me.TR(me);
		me.TD(me, 1, 0.5, e = makeXonoticCheckBox(0, "r_stereo_redcyan", _("*Red/Cyan*")));
			e.colorL = '0 1 1'; e.cvarOffValue = "-1";
		me.TD(me, 1, 0.5, e = makeXonoticCheckBox(0, "r_stereo_redblue", _("Red/Blue")));
			e.colorL = '0 0 1'; e.cvarOffValue = "-1";
		me.TD(me, 1, 0.5, e = makeXonoticCheckBox(0, "r_stereo_redgreen", _("Red/Green")));
			e.colorL = '0 1 0'; e.cvarOffValue = "-1";
		
		me.TDempty(me, 0.2);

		me.TD(me, 1, 0.5, e = makeXonoticTextLabel(0, _("Separation")));
		me.TD(me, 1, 0.6, e = makeXonoticSlider(0, 6, 0.1, "r_stereo_separation"));
		
		me.TDempty(me, 0.2);
		me.TD(me, 1, 0.3, e = makeXonoticTextLabel(0, _("Angle")));
		me.TD(me, 1, 0.6, e = makeXonoticSlider(0, 90, 1, "r_stereo_angle"));
