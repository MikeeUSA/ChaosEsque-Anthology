...
CLASS(MainWindow) EXTENDS(ModalController)
	...
	ATTRIB(MainWindow, startweaponsDialog, entity, NULL)
	ATTRIB(MainWindow, startweaponsdmDialog, entity, NULL)
	ATTRIB(MainWindow, startmagicDialog, entity, NULL)
	ATTRIB(MainWindow, startmagicdmDialog, entity, NULL)
	ATTRIB(MainWindow, presetsDialog, entity, NULL)
	ATTRIB(MainWindow, mountedgunsDialog, entity, NULL)
	ATTRIB(MainWindow, mountedgunsdmDialog, entity, NULL)
	ATTRIB(MainWindow, vehiclesDialog, entity, NULL)
	ATTRIB(MainWindow, vehiclesdmDialog, entity, NULL)
...
void MainWindow_configureMainWindow(entity me)
{
	...
	me.startweaponsDialog = i = spawnXonoticStartweaponsDialog();
	i.configureDialog(i);
	me.addItemCentered(me, i, i.intendedWidth * eX + i.intendedHeight * eY, SKINALPHAS_MAINMENU_z);
	
	me.startweaponsdmDialog = i = spawnXonoticStartweaponsdmDialog();
	i.configureDialog(i);
	me.addItemCentered(me, i, i.intendedWidth * eX + i.intendedHeight * eY, SKINALPHAS_MAINMENU_z);
	
	me.startmagicDialog = i = spawnXonoticStartmagicDialog();
	i.configureDialog(i);
	me.addItemCentered(me, i, i.intendedWidth * eX + i.intendedHeight * eY, SKINALPHAS_MAINMENU_z);
	
	me.startmagicdmDialog = i = spawnXonoticStartmagicdmDialog();
	i.configureDialog(i);
	me.addItemCentered(me, i, i.intendedWidth * eX + i.intendedHeight * eY, SKINALPHAS_MAINMENU_z);

	me.presetsDialog = i = spawnXonoticPresetsDialog();
	i.configureDialog(i);
	me.addItemCentered(me, i, i.intendedWidth * eX + i.intendedHeight * eY, SKINALPHAS_MAINMENU_z);
	
	me.mountedgunsDialog = i = spawnXonoticMountedgunsDialog();
	i.configureDialog(i);
	me.addItemCentered(me, i, i.intendedWidth * eX + i.intendedHeight * eY, SKINALPHAS_MAINMENU_z);
	
	me.mountedgunsdmDialog = i = spawnXonoticMountedgunsdmDialog();
	i.configureDialog(i);
	me.addItemCentered(me, i, i.intendedWidth * eX + i.intendedHeight * eY, SKINALPHAS_MAINMENU_z);
	
	me.vehiclesDialog = i = spawnXonoticVehiclesDialog();
	i.configureDialog(i);
	me.addItemCentered(me, i, i.intendedWidth * eX + i.intendedHeight * eY, SKINALPHAS_MAINMENU_z);
	
	me.vehiclesdmDialog = i = spawnXonoticVehiclesdmDialog();
	i.configureDialog(i);
	me.addItemCentered(me, i, i.intendedWidth * eX + i.intendedHeight * eY, SKINALPHAS_MAINMENU_z);
	...
	// miscellaneous dialogs
	i = spawnXonoticPlayerclassSelectDialog();
	i.configureDialog(i);
	me.addItemCentered(me, i, i.intendedWidth * eX + i.intendedHeight * eY, SKINALPHAS_MAINMENU_z);
	
	// miscellaneous dialogs
	i = spawnXonoticCustomWeaponSkinDialog();
	i.configureDialog(i);
	me.addItemCentered(me, i, i.intendedWidth * eX + i.intendedHeight * eY, SKINALPHAS_MAINMENU_z);
