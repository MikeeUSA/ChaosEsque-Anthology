...
void XonoticMiscSettingsTab_fill(entity me)
{
	...
	me.TR(me);
		...
		{
		me.TDempty(me, 0.2);
		me.TD(me, 1, 1, e = makeXonoticSlider(1, 3, 1, "crypto_aeslevel"));
		me.TD(me, 1, 1.8, e = makeXonoticTextLabel(0, _("Use encryption (AES) when available")));
			e.colorL = '1 0.8 0'; e.cvarOffValue = "0";
		me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 2.8, e = makeXonoticTextLabel(0, _("0 = unsupported :: 1 = supported :: 2 = requested :: 3 = required")));
			e.colorL = '1 0.8 0'; e.cvarOffValue = "0";
		...
		{
		me.TDempty(me, 0.2);
		me.TD(me, 1, 3.1, e = makeXonoticTextLabel(0, _("Encryption Not Supported by Engine Version :( You Should Take It Upon Yourself To")));
			e.colorL = '1 0 0'; e.cvarOffValue = "0";
		me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 3.1, e = makeXonoticTextLabel(0, _("Compile A Version Of The Darkplaces Engine Which Supports AES Crypto. PostHaste")));
			e.colorL = '1 0 0'; e.cvarOffValue = "0";
		}
		me.TR(me);
		me.TDempty(me, 0.2);
	...
	me.TR(me);
	me.TR(me);
		me.TD(me, 1, 1, e = makeXonoticCheckBox(0, "showtime", _("Show current time")));
		
		me.TDempty(me, 0.1);
		me.TD(me, 1, 0.5, e = makeXonoticTextLabel(0, _("Server FPS")));
		me.TD(me, 1, 1.4, e = makeXonoticTextSlider("sys_ticrate"));
			e.addValue(e, _("30 (1800FPM)"), "0.0333333");
			e.addValue(e, _("*45 (2700FPM)*"), "0.0222222");
			e.addValue(e, _("60 (3600FPM)"), "0.0166666");
			e.addValue(e, _("90 (5400FPM)"), "0.0111111");
			e.addValue(e, _("135(8100FPM)"), "0.0074074");
			e.addValue(e, _("180(10800FPM)"),"0.0055555");
			//e.addValue(e, _("NoLimit"),"0");
			e.configureXonoticTextSliderValues(e);
	me.TR(me);
		me.TD(me, 1, 1, e = makeXonoticCheckBox(0, "showdate", _("Show current date")));
		
		me.TDempty(me, 0.1);
		me.TD(me, 1, 0.5, e = makeXonoticTextLabel(0, _("Client FPS")));
		me.TD(me, 1, 1.4, e = makeXonoticTextSlider("cl_netfps"));
			e.addValue(e, _("30 (1800FPM)"), "30");
			e.addValue(e, _("45 (2700FPM)"), "45");
			e.addValue(e, _("*60 (3600FPM)*"), "60");
			e.addValue(e, _("90 (5400FPM)"), "90");
			e.addValue(e, _("135(8100FPM)"), "135");
			e.addValue(e, _("180(10800FPM)"),"180");
			e.configureXonoticTextSliderValues(e);
	me.TR(me);
